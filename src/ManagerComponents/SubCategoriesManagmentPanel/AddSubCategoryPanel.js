...
import { addSubCategory } from "../../app/subCategoriesSlice";

const AddSubCategoryPanel = () => {
    ...
    const addCategory = async() => {
        ...
        setErrors(reser);
        if(reser === ""){
            let res = await dispatch(addSubCategory({subCategoryName: categoryName}));
            console.log(res);
        ...
        <div>
            <form>
                <div className="flexbox-row">
                    <input value={categoryName} onChange={(e) => setCategoryName(e.target.value)} type="text" maxLength='40' minLength='5' className="form-control mt-1" placeholder="Sub-category name"></input>
...
export default AddSubCategoryPanel;