...
import { getAdmins, deleteUser, selectValues } from '../../app/usersSlice';
...
const AdminTabel = () => {
    ...
    return (
        <div>
            <input className='admin-search' onChange={(e) => setSearch(e.target.value)} type='text' placeholder='Search admin'></input>
            <table>
            <thead>
                <tr>
                    <th>Id</th>
